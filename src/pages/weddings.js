    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <Container>
          ...
          <p>Axe Throwing makes the perfect Bachelor Party Idea, Axe Throwing fits the many Lumberjack themed events held in Colorado, Interactive corporate team events, Birthday Parties, and more.</p>
