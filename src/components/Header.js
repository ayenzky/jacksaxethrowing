                ...
                <Row>
                    ...
                    <Col md={5} className="d-flex justify-content-end align-items-center">
                        <ul className="list-unstyled d-flex socialicons mb-0 flex-wrap">
                            <li className="mb-1 mb-lg-0 mr-2"><a title="facebook" href="https://www.facebook.com/jacksaxethrowing/" target="_blank" rel="noopener noreferrer">
                              <LazyLoadImage alt="facebook" effect="blur" src="/img/003-facebook.svg"/></a></li>
                            <li className="mb-1 mb-lg-0 mr-2"><a title="twitter" href="https://twitter.com/JackThrows" target="_blank" rel="noopener noreferrer">
                              <LazyLoadImage alt="twitter" effect="blur" src="/img/twitter.svg"/></a></li>
                            <li className="mb-1 mb-lg-0 mr-2"><a title="youtube" href="https://www.youtube.com/channel/UColhr8JVcg17NkngWtAlSkA" target="_blank" rel="noopener noreferrer">
                              <LazyLoadImage alt="youtube" effect="blur" src="/img/youtube.svg"/></a></li>
                            <li className="mb-1 mb-lg-0 mr-2"><a title="yelp" href="https://www.yelp.com/biz/jacks-axe-throwing-colorado-springs-2" target="_blank" rel="noopener noreferrer">
                ...
                <Row className="d-flex align-items-center">
                    ...
                    <Col xs={4} md={4}>
                        <div className="text-sm-left text-md-center nav-brand">
                          <Link to="/"><LazyLoadImage alt="logo" effect="blur" className="img-fluid mb-0" src="/img/logo.png"/></Link>
                        </div>
                    </Col>
