            ...
            <div className="navigation-top">
              <Nav className="flex-column main-nav">
                ...
                <Dropdown className="nav-item">
                  <Link to="/services" className="nav-link float-left">
                    Services
                  </Link>
                  <Dropdown.Toggle
                    split
                  ...
                  <Dropdown.Menu>
                    ...
                    <Link to="/weddings" className="dropdown-item nav-link">
                      Weddings
                    </Link>
                    <Link
                      to="/family-reunions"
                    ...
                    <Link to="/festivals" className="dropdown-item nav-link">
                      Festivals
                    </Link>
                    <Link
                      to="/non-profit-events"
                      className="dropdown-item nav-link"
                    >
            ...
            <div className="navigation-bottom text-white">
              <ul className="list-unstyled topinfo">
                <li className="d-flex align-content-start mb-1">
                  ...
                  />
                  <a href="tel://7194979709" title="telephone">
                    (719) 497-9709
                  </a>
                </li>
