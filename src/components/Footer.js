		...
		<Container>
			<Row>
					...
					<ul className="list-unstyled m-0 topinfo text-white">
						<li className="d-flex align-content-start">
							<LazyLoadImage
								...
								className="mr-2 mt-1"
							/>
							<a title="telephone" href="tel://7194979709">
								(719) 497-9709
							</a>
						</li>
						<li className="d-flex align-items-start">
							<LazyLoadImage
								...
								className="mr-2 mt-1"
							/>
							<a title="email" href="mailto:jack@jacksaxethrowing.com">
				...
				<Col lg={5} className="order-2 order-md-3">
					...
					<ul className="list-unstyled m-0 d-flex flex-wrap footer-services-links">
						<li className="text-white">
							<Link to="/birthday-parties">Birthday Parties</Link>
						</li>
						<li className="text-white">
							<Link to="/bachelorette-parties">Bachelor/ette Parties</Link>
						</li>
						<li className="text-white">
						...
						<li className="text-white">
							<Link to="/family-reunions">Family Reunions</Link>
						</li>
						<li className="text-white">
							<Link to="/mobile-axe-throwing">Mobile Axe Throwing</Link>
						</li>
						<li className="text-white">
							<Link to="/festivals">Festivals</Link>
						</li>
						<li className="text-white">
							<Link to="/non-profit-events">Non-profit Fundraiser</Link>
						</li>
						<li className="text-white">
						...
						<li className="text-white">
							<Link to="/travelling-custom-events-indoors-and-outdoors">
			...
			<div className="copyright pt-5 mt-5 pb-4">
				<p className="text-white mb-0">
					© Copyright {new Date().getFullYear()} - Jack's Axe Throwing - All
					Rights Reserved - Designed by{" "}
					<a href="https://www.webriq.services/" title="webriq goes mad">
						WebriQ Goes Mad
					</a>{" "}
					- Powered by{" "}
					<a href="https://www.webriq.com/" title="webriq">
						WebriQ
					</a>
				</p>
			</div>
